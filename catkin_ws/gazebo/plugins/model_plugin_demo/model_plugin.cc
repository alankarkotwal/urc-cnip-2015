...
namespace gazebo
{
  class ModelPluginDemo : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
    {
      ...
      this->model = _parent;
      this->rear_right_wheel = _parent->GetJoint("back_right_joint");
      this->rear_left_wheel = _parent->GetJoint("back_left_joint");
      this->front_right_wheel = _parent->GetJoint("front_right_joint");
      this->front_left_wheel = _parent->GetJoint("front_left_joint");
